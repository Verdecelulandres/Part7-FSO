  ...
  describe("Login", () => {
    ...
    describe("When logged in", () => {
      ...
      test("a new blog can be created", async ({ page }) => {
        ...
        await expect(
          page.getByText("Test blog", { exact: true }),
        ).toBeVisible();
      });
      ...
      describe("When blogs exist", () => {
        ...
        describe("When deleting", () => {
          test("blog creator can delete a blog", async ({ page }) => {
            ...
            const blogToRemoveLink = await page.getByRole("link", {
              name: "blog2",
            });
            await goToBlog(page, "blog2");
          ...
          test("only blog creator sees remove button", async ({
            page,
            request,
          }) => {
            await request.post("/api/users", {
        ...
        describe("When liking", () => {
          ...
          test("blogs are sorted according to likes descendently", async ({
            page,
          }) => {
